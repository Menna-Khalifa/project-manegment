                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('dept') is-invalid @enderror" id="dept"
                                        ...
                                        <option value="project" {{ old('dept') == 'project' ? 'selected' : '' }}>Project
                                        </option>
                                        <option value="facility" {{ old('dept') == 'facility' ? 'selected' : '' }}>Facility
                                        </option>
                                        <option value="maintenance_replacing"
                                            {{ old('dept') == 'maintenance_replacing' ? 'selected' : '' }}>Maintenance /
                                            Replacing</option>
                                        <option value="maintenance" {{ old('dept') == 'maintenance' ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('region') is-invalid @enderror" id="region"
                                        ...
                                        <option value="western_province"
                                            {{ old('region') == 'western_province' ? 'selected' : '' }}>Western Province
                                        </option>
                                        <option value="central_province"
                                            {{ old('region') == 'central_province' ? 'selected' : '' }}>Central Province
                                        </option>
                                        <option value="eastern_province"
                                            {{ old('region') == 'eastern_province' ? 'selected' : '' }}>Eastern Province
                                        </option>
                                        <option value="general" {{ old('region') == 'general' ? 'selected' : '' }}>General
                                        </option>
                                    </select>
                                    @error('region')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    ...
                                    <select class="form-control select2 @error('store_id') is-invalid @enderror"
                                        ...
                                        @foreach ($stores as $store)
                                            <option value="{{ $store->id }}"
                                                {{ old('store_id') == $store->id ? 'selected' : '' }}>{{ $store->uuid }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('store_id')
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('request_status') is-invalid @enderror"
                                        ...
                                        <option value="new_order"
                                            {{ old('request_status') == 'new_order' ? 'selected' : '' }}>New Order</option>
                                        <option value="under_working"
                                            {{ old('request_status') == 'under_working' ? 'selected' : '' }}>Under Working
                                        </option>
                                        <option value="completed"
                                            {{ old('request_status') == 'completed' ? 'selected' : '' }}>Completed</option>
                                        <option value="on_hold"
                                            {{ old('request_status') == 'on_hold' ? 'selected' : '' }}>On Hold</option>
                                        <option value="cancelled"
                                            {{ old('request_status') == 'cancelled' ? 'selected' : '' }}>Cancelled</option>
                                    </select>
...
@section('js')
    <script>
        ...
        $(document).ready(function() {
            ...
            // Trigger change if store_id is already selected (e.g., on validation error)
            if ($('#store_id').val()) {
