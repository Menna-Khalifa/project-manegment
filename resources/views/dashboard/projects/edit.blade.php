            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Edit Project: {{ $project->name }}</h4>
                        <div>
                    ...
                    <form action="{{ route('projects.update', $project->id) }}" method="post">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('po_num') is-invalid @enderror"
                                        id="po_num" name="po_num" value="{{ old('po_num', $project->po_num) }}"
                                        required>
                                    @error('po_num')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <option value="government"
                                        {{ old('type', $project->type) == 'government' ? 'selected' : '' }}>Government
                                    </option>
                                    <option value="commercial"
                                        {{ old('type', $project->type) == 'commercial' ? 'selected' : '' }}>Commercial
                                    </option>
                                    <option value="residential"
                                        {{ old('type', $project->type) == 'residential' ? 'selected' : '' }}>Residential
                                    </option>
                                    </select>
                                    @error('type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('project_cost') is-invalid @enderror"
                                        ...
                                        value="{{ old('project_cost', $project->project_cost) }}" required>
                                    @error('project_cost')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="las la-save"></i> Update Project
                            </button>
