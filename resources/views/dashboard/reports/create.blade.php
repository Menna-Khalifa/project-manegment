<!-- resources/views/dashboard/reports/create.blade.php -->
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header pb-0">
                    <h4 class="card-title mg-b-0">New Report</h4>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('reports.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <select name="project_amer_id" id="project_amer_id" class="form-control select2">
                                        ...
                                        @foreach ($projects as $project)
                                            <option value="{{ $project->id }}"
                                                {{ old('project_amer_id') == $project->id ? 'selected' : '' }}>
                                                {{ $project->po_num }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div id="store-manual-fields" style="display: none;">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                        ...
                        <div id="sites-refer-section" style="display: none;">
                            <div class="card mt-4">
                        ...
                        <div id="project-items-section" style="display: none;">
                        ...
                        <!-- Custom Fields Section -->
                        <div id="custom-fields-container" style="display: none;" class="custom-fields-section">
                        ...
                        <div class="form-group mt-3">
                            <label>Notes</label>
                            <textarea name="notes" class="form-control" rows="4" placeholder="Add any additional notes here...">{{ old('notes') }}</textarea>
                            @error('notes')
                                <small class="text-danger">{{ $message }}</small>
                            @enderror
                        </div>
...
<script>
    ...
    `;
        ...
        if ($('#report_type').val()) {
            loadReportTypeData($('#report_type').val());
        }
