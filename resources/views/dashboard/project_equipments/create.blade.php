            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">Add New Project Equipment</h4>
                    ...
                    <form action="{{ route('project-equipments.store') }}" method="post">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('status') is-invalid @enderror" id="status" name="status" required>
                                        ...
                                        <option value="not_delivered" {{ old('status') == 'not_delivered' ? 'selected' : '' }}>Not Delivered</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="las la-save"></i> Add Equipment
                            </button>
