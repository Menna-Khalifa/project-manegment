        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" action="{{ route('equipments.update', $equipment->id) }}" method="post"
                            ...
                            <div class="col-md-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="Name" name="name"
                                        value="{{ $equipment->name }}" type="text">
                                    @error('name')
                            ...
                            <div class="col-md-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="Count" name="count"
                                        value="{{ $equipment->count }}" type="text">
                                    @error('count')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="Description" name="description"
                                        value="{{ $equipment->description }}" type="text">
                                    @error('description')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
