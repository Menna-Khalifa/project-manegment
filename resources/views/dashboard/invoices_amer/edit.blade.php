                ...
                <div class="card-body">
                    <form action="{{ route('invoices_amer.update', $invoice->id) }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <select name="project_amer_id" id="project_amer_id" disabled class="form-control select2" required>
                        ...
                        <div class="row" id="project-info">
                            <div class="col-12">
                                <div class="alert alert-info">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <strong>Total Cost:</strong> <span id="total-cost">{{ number_format($invoice->projectAmer->amount, 2) }}</span> SAR
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" min="0.01"
                                               max="{{ $invoice->projectAmer->amount }}"
