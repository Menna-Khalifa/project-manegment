...
@section('content')
    <div class="invoice-container">
            ...
            <table class="table table-invoice border text-md-nowrap mb-0">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="tx-12">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                            doloremque laudantium, totam rem aperiam...</td>
                    ...
                    <tr>
                        ...
                        <td class="tx-12">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis
                            praesentium voluptatum deleniti atque...</td>
                    ...
                    <tr>
                        <td>Android App</td>
                        <td class="tx-12">Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur,
                            adipisci velit, sed quia non numquam eius modi tempora incidunt ut</td>
        ...
        <div class="d-flex flex-wrap gap-2 mt-3">
            <a class="btn btn-purple mr-2" href="">
