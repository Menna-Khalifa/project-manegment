        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="needs-validation" action="{{ route('stores.update', $store->id) }}" method="post"
                                ...
                                <div class="form-group mg-b-0">
                                    ...
                                    <select class="form-control select2" name="brand_id">
                                        @foreach ($brands as $brand)
                                            ...
                                            <option value="{{ $brand->id }}" {{ old('brand_id', $store->brand_id) == $brand->id ? 'selected' : '' }}>{{ $brand->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('brand_id')
                            ...
                            <div class="col-md-6 mg-b-20">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="Email" name="email"
                                        value="{{ old('email', $store->email) }}" type="email">
                                    @error('email')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mg-b-20">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="Phone" name="phone"
                                        value="{{ old('phone', $store->phone) }}" type="text">
                                    @error('phone')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mg-b-20">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="Country" name="country"
                                        value="{{ old('country', $store->country) }}" type="text">
                                    @error('country')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mg-b-20">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="City" name="city"
                                        value="{{ old('city', $store->city) }}" type="text">
                                    @error('city')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mg-b-20">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="State" name="state"
                                        value="{{ old('state', $store->state) }}" type="text">
                                    @error('state')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mg-b-20">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="Address" name="address"
                                        value="{{ old('address', $store->address) }}" type="text">
                                    @error('address')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 mg-b-20">
                                <div class="form-group mg-b-0">
                                    ...
                                    <input class="form-control" placeholder="Zip" name="zip"
                                        value="{{ old('zip', $store->zip) }}" type="text">
                                    @error('zip')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
