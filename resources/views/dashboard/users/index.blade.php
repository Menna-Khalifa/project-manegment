                        ...
                        <table class="table text-nowrap table-bordered border-primary">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('admins.group_name') }}</th>
                                    <th>{{ __('admins.status') }}</th>
                                    @if (auth()->user()->can('show_user') ||
                                            auth()->user()->can('edit_user') ||
                                            auth()->user()->can('edit_status_user') ||
                                            auth()->user()->can('assign_role_user') ||
                            ...
                            <tbody>
                                ...
                                @foreach ($users as $key => $admin)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $admin->group->name ?? __('general.not_found') }}</td>
                                        <td class="">
                                    ...
                                    <div class="modal" id="modaldemo8-assign_role-{{ $admin->id }}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                ...
                                                <form action="{{ route('user.assign_role', $admin->id) }}" method="post">
                                                    {{ csrf_field() }}
                                    ...
                                    <div class="modal" id="modaldemo8-editStatus-{{ $admin->id }}">
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content modal-content-demo">
                                                ...
                                                <form action="{{ route('user.edit_status', $admin->id) }}"
                                                    method="post">
                                                    {{ csrf_field() }}
                                                    <div class="modal-body">
